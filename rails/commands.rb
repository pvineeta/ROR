To create a new app: rails new app_name
To install a new gem: bundle install
To start your rails app/server: rails s or rails server
To see all available routes: rails routes
